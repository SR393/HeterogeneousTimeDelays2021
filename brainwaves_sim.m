...
%Commented out following lines because they introduced errors (parameters
%not recognised in BDT because they are implemented as vectors here, but
%individually in BDT). All parameters must be set manually in BDT.
