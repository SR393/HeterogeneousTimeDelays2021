...
fig, axes = plt.subplots(4, 6, figsize = (14, 9), subplot_kw={'projection':'3d'}, gridspec_kw = {'wspace':0.0, 'hspace':0})
...
ax = fig.add_axes([0.07, 0.08, 0.63, 0.000001])
ax.set_xlabel('Conduction Speed (m/s)', size = 25, labelpad = 5)
ax.axes.get_yaxis().set_visible(False)
ax.set_xticks(np.linspace(1/6, 1, 6))
ax.set_xticklabels(['40', '60', '80', '100', '120', '140'], size = 15)

ax = fig.add_axes([0.1, 0, 0.000001, 0.78])
ax.set_ylabel('Connection Strength (a.u.)', size = 30, labelpad = 20)
ax.axes.get_xaxis().set_visible(False)
ax.set_yticks(np.linspace(0.25, 1, 4))
ax.set_yticklabels(['0.5', '0.6', '0.7', '0.8'], size = 15)
